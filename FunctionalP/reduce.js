// he reduce method allows for more general forms of array processing, 
...
const watchList = [
  ...
  function getRating(watchList) {
    ...
    let averageRating = watchList.filter((elem)=>elem.Director ==="Christopher Nolan" ).map((elem)=>Number(elem.imdbRating)).reduce((SumofRating, rating) => SumofRating + rating)/watchList.filter(film => film.Director === "Christopher Nolan").length;
